...
fn main() {
    ...
    let (mut ctx, mut event_loop) = ContextBuilder::new("GeoCrash", "THe Cool Kids")
        .build()
    ...
    //spawn actual game objects and players
    my_game.spawn_game_objects();
...
pub fn create_bound(master: &mut Master, pos: Vector2<f32>, size: Vector2<f32>) -> (DefaultBodyHandle, DefaultColliderHandle) {
